...
import 'package:dart_basic/23_12_18/exam/exam5/post_file_repository_impl.dart';
import 'package:dart_basic/23_12_18/exam/exam5/post_manager.dart';
import 'package:dart_basic/23_12_18/exam/exam5/post_memory_repository_impl.dart';
...
void main() {
  ...
  group('memory', () {
    test('Post Manager add Test', () async {
      ...
      await postManager
          .addPost(Post(userId: 1, id: 1, title: 'title', body: 'body'));
      await postManager
          .addPost(Post(userId: 1, id: 2, title: 'title2', body: 'body2'));

      postManager
          .addPost(Post(userId: 1, id: 3, title: 'title3', body: 'body3'));
